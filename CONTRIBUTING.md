...
5. Open a Pull Request with:
   - **What broke** — link to the issue
   - **Root cause** — one sentence explanation
   - **What changed** — specific files + lines
   - **How you tested** — terminal output showing it works
...
### Photo Requirements
- **Resolution:** Minimum 1280×720, prefer 1920×1080
